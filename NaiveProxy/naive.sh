...
config() {
    ...
    wget -c https://raw.githubusercontent.com/852us/NaiveProxy/main/html.tar.gz -O - | tar -xz -C /var/www/
    # 生成密码
...
optimize(){
    curl https://raw.githubusercontent.com/852us/NaiveProxy/main/optimize.sh | bash -
